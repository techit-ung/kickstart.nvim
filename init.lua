...
do
  ...
  -- Custom tab and indentation defaults
  vim.o.tabstop = 2
  vim.o.softtabstop = 2
...
do
  ...
  -- Custom statusline (instead of mini.statusline).
...
-- Custom file explorer; dependencies are installed before Neo-tree.
vim.pack.add { gh 'nvim-lua/plenary.nvim', gh 'MunifTanjim/nui.nvim' }
vim.pack.add { { src = gh 'nvim-neo-tree/neo-tree.nvim', version = 'v3.x' } }

vim.api.nvim_create_user_command('ReloadAs', function(opts)
  local ft = opts.fargs[1]
  vim.cmd('set ft=' .. ft)
  vim.notify('Reloaded buffer as ' .. ft, vim.log.levels.INFO)
end, {
  nargs = 1,
})
